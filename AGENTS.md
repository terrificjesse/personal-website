...
This file governs how Codex should work in this repo. Read it before making changes.
If a subproject has its own `AGENTS.md` (e.g. `apps/fridge-app/AGENTS.md`), that file's
...
personal-website/
  ...
  apps/
    fridge-app/
      ...
      AGENTS.md               # fridge-app-specific notes (data model, endpoints, phase status)
  content/
